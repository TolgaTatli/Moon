...
I have been coding for many years with C, C++, Java, and most recently Python. My technical interests include security, data analytics and distributed systems. Currently I work at [VWmare](https://vmware.com){:target="_blank"} helping bring the power of behavior analytics to the [Workspace ONE platform](https://www.vmware.com/products/workspace-one.html){:target="_blank"}. My specific role is to develop the analytics ETL pipeline.
