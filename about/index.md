...
Thanks to [Github](https://github.com){:target="blank"} for providing free website hosting with the support for the [Jekyll](https://jekyllrb.com/){:target="blank"} framework.  
